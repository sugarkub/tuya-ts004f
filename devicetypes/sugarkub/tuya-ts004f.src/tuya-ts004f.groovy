 ...
 * ---------
 * ! 3 ! 4 !
 * ---------   Button 3 is the one that must be pressed ~10 seconds to start the zigbee pairing process
 *
 ...
 *
 * 2021-11-16 sugarkub - adjust code indentation and change button mapping {4 | 3 | 1 | 2} -> {1 | 2 | 3 | 4}
 */
...
metadata {
    definition (name: "Tuya TS004F", namespace: "sugarkub", author: "sugarkub", ocfDeviceType: "x.com.st.d.remotecontroller", mcdSync: true, runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: true, genericHandler: "Zigbee") {
        capability "Refresh"
        capability "Button"
